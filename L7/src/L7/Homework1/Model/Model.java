...
public class Model {
    ...
    public String getGig_number() {return Gig_number;}
    public void setGig_number(String gig_number) {Gig_number = gig_number;}
    ...
    public void Check()
    {
        ...
        try {
            Connection connection2 = DriverManager.getConnection("jdbc:mysql://localhost:3306/L7","root","myjava123");
